...
public class ProcessProfileModel
{
    ...
    public void ProcessAndSendProfile(LocalRaidSettings localRaidSettings, GClass1959 resultRaid)
    {
    ...
    /// </summary>
    private ProfileData DeserializeProfileData(GClass1959 resultRaid)
    {
        try
        {
    ...
    private (string gameVersion, string lastRaidLocationRaw, string lastRaidLocation) GetRaidInfo(
        LocalRaidSettings localRaidSettings, GClass1959 resultRaid, Profile profile)
    {
    ...
    private void ProcessAndSendProfileData(
        ...
        bool isScavRaid, GClass1959 resultRaid)
    {
    ...
    /// Gets killer name
    /// </summary>
    private string GetKillerName(GClass1959 resultRaid, Profile pmcData, Profile scavData)
    {
    ...
    /// </summary>
    private int CalculateRaidRevenue(GClass1959 resultRaid, bool isScavRaid)
    {
    ...
    /// </summary>
    private (bool isTransition, string lastRaidTransitionTo) GetTransitionData(GClass1959 resultRaid)
    {
    ...
    private void CreateAndSendProfileData(
        ...
        Profile pmcData, Profile scavData, GClass1959 resultRaid)
    {
        if (haveDevItems)
            return;
    ...
    private BaseData CreateBaseData(string profileId, string gameVersion, bool isScavRaid, float maxHealth,
        float currentHealth, Profile pmcData, int killedPmc, GClass1959 resultRaid,
